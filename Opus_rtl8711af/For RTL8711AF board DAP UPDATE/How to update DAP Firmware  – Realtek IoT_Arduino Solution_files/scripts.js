 ...
 ***********************************************/
  ...
  /* Language detection */
$('a[hreflang="zh"]').on( 'click', function(event){
	event.preventDefault();
	//console.log('click: zh');
	if( !$('.lang-zh').hasClass('active') ){
		Cookies.set('ameba_lang', 'zh');
		var cur_path = window.location.pathname.substring(3, window.location.pathname.length);
		window.location.href = '/zh' + cur_path;
		//console.log('to zh');
	}
});
$('a[hreflang="cn"]').on('click', function(event){
	event.preventDefault();
	//console.log('click: cn');
	if( !$('.lang-cn').hasClass('active') ){
		Cookies.set('ameba_lang', 'cn');
		if( window.location.href.indexOf("/en/") != -1 || window.location.href.indexOf("/jp/") != -1 
		...
		window.location.href = '/cn' + cur_path;
		//console.log('to cn');
	}
});
$('a[hreflang="en"]').on('click', function(event){
	event.preventDefault();
	//console.log('click: en');
	if( !$('.lang-en').hasClass('active') ){
		Cookies.set('ameba_lang', 'en');
		if( window.location.href.indexOf("/cn/") != -1 || window.location.href.indexOf("/jp/") != -1 
			|| window.location.href.indexOf("/kr/") != -1 ){
			var cur_path = window.location.pathname.substring(3, window.location.pathname.length);
		}
		else{
		...
		window.location.href = '/en' + cur_path;
		//console.log('to en');
	}
});
$('a[hreflang="jp"]').on('click', function(event){
	event.preventDefault();
	//console.log('click: jp');
	if( !$('.lang-jp').hasClass('active') ){
		Cookies.set('ameba_lang', 'jp');
		if( window.location.href.indexOf("/cn/") != -1 || window.location.href.indexOf("/en/") != -1 
			|| window.location.href.indexOf("/kr/") != -1 ){
			var cur_path = window.location.pathname.substring(3, window.location.pathname.length);
		}
		else{
		...
		window.location.href = '/jp' + cur_path;
		//console.log('to jp');
	}
});
$('a[hreflang="kr"]').on('click', function(event){
	event.preventDefault();
	//console.log('click: kr');
	if( !$('.lang-kr').hasClass('active') ){
		Cookies.set('ameba_lang', 'kr');
		if( window.location.href.indexOf("/cn/") != -1 || window.location.href.indexOf("/en/") != -1 
			|| window.location.href.indexOf("/jp/") != -1 ){
			var cur_path = window.location.pathname.substring(3, window.location.pathname.length);
		}
		else{
			var cur_path = window.location.pathname		
		}
		window.location.href = '/kr' + cur_path;
		//console.log('to kr');
	}
});


if( typeof Cookies.get('ameba_lang') === 'undefined' ){
	//console.log("no cookie!!!");
	// no saved language preference (no cookie) --> use browser language
	var navi_language = window.navigator.language;
	//console.log('navigator language: ' + navi_language);
	
    if(navi_language == 'zh-TW'){
		Cookies.set('ameba_lang', 'zh', { expires: 365 });
	}
	else if(navi_language == 'zh-CN'){
		Cookies.set('ameba_lang', 'cn', { expires: 365 });
	}
	else if(navi_language == 'en-US' || navi_language == 'en'){
		Cookies.set('ameba_lang', 'en', { expires: 365 });
	}
	else if(navi_language == 'ja'){
		Cookies.set('ameba_lang', 'jp', { expires: 365 });
	}
	else if(navi_language == 'ko'){
		Cookies.set('ameba_lang', 'kr', { expires: 365 });
	}
	else{
		Cookies.set('ameba_lang', 'en', { expires: 365 });
	}
	...
	var lang = Cookies.get('ameba_lang');
	//console.log('cookie lang = ' + lang);
	switch(lang){
		case 'zh':
			if( !$('.lang-zh').hasClass('active') ){
				$('a[hreflang="zh"]').trigger('click');
				//console.log('zh trigger click');
			}
			break;
		case 'cn':
			if( !$('.lang-cn').hasClass('active') ){
				$('a[hreflang="cn"]').trigger('click');
				//console.log('cn trigger click');
			}
			break;
		case 'en':
			if( !$('.lang-en').hasClass('active') ){
				$('a[hreflang="en"]').trigger('click');
				//console.log('en trigger click');
			}
			break;
		case 'jp':
			if( !$('.lang-jp').hasClass('active') ){
				$('a[hreflang="jp"]').trigger('click');
				//console.log('jp trigger click');
			}
			break;
		case 'kr':
			if( !$('.lang-kr').hasClass('active') ){
				$('a[hreflang="kr"]').trigger('click');
				//console.log('kr trigger click');
			}
			break;
	}
}
$('.qtranxs-available-language-link-zh').on( 'click', function(event){
	event.preventDefault();
	//console.log('switch to zh');
	$('a[hreflang="zh"]').trigger('click');
});
$('.qtranxs-available-language-link-cn').on( 'click', function(event){
	event.preventDefault();
	//console.log('switch to zh');
	$('a[hreflang="cn"]').trigger('click');
});
$('.qtranxs-available-language-link-en').on( 'click', function(event){
	event.preventDefault();
